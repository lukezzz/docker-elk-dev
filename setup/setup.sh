...
create_keystore()
{
    ...
    ## Setting Secure pwd for mail
    echo "Setting mail secure password..."
    elasticsearch-keystore add xpack.notification.email.account.126_account.smtp.secure_password
